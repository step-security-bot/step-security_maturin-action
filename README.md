...
[![GitHub Actions](https://github.com/step-security/maturin-action/actions/workflows/test.yml/badge.svg)](https://github.com/step-security/maturin-action/actions?query=workflow%3ATest)
...
`step-security/maturin-action` instead, for example
...
[#313](https://github.com/step-security/maturin-action/issues/313)). Use a matrix with one interpreter per
job instead.
